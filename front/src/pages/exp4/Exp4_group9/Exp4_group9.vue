    ...
    <div>
      <a-collapse v-model:activeKey="activeKey1" :bordered="false" style="width:99%">
        ...
        <a-collapse-panel  key="1" :show-arrow="false" style="background-color: white;font-size:16px">
          ...
          <div>
            <h4 style="font-weight:600;">1.1.1 测试环境成本</h4>
          ...
          <div>
            <h4 style="font-weight:600;">1.1.3 测试工具成本</h4>
          ...
          <div>
            <h4 style="font-weight:600;">1.2.1 概述</h4>
            <p>&emsp;&emsp;软件测试间接成本包括办公成本和管理成本。</p>
          </div>
          <div>
            <h4 style="font-weight:600;">1.2.2 办公成本</h4>
          ...
          <div>
            <h4 style="font-weight:600;">1.2.3 管理成本</h4>
        ...
        <a-collapse-panel  key="2" :show-arrow="false" style="background-color: white;font-size:16px">
          ...
          <h4 style="font-weight:600;">2.1 软件复杂性</h4>
          <div>
          ...
          <h4 style="font-weight:600;">2.2 软件完整性</h4>
          <div>
            <p>&emsp;&emsp;软件完整性级别是系统完整性级别在包含软件部件或仅包含软件部件或仅包含软件的子系统上的分配。按照 GB/T18492—2001 给出的软件完整性级别来确定调整因子取值范围，如表2所示。</p>
            <div style="font-size:14px">
              <a-row justify="center" style="text-align:center;">
          ...
          <h4 style="font-weight:600;">2.3 测试风险度</h4>
          <div>
        ...
        <a-collapse-panel  key="3" :show-arrow="false" style="background-color: white;font-size:16px">
          ...
          <div>
            <p>本实验指导书中采用国际软件测试成本度量规范，度量目标项目软件测试成本。建议按照以下步骤执行度量过程。</p>
            <h4 style="font-weight:600;">3.1 软件测试的人工成本工作量计算如式(1)所示：</h4>
          ...
          <div>
            <h4 style="font-weight:600;">3.2 软件测试成本调整因子计算如式(2)所示：</h4>
            <a-row justify="center">&emsp;&emsp;<strong>DF =C ×I×R ×U ×X ×A × (1+n×Tr) …………………………(2)</strong></a-row>
            <div style="font-size:14px;">
              <p>&emsp;&emsp;式中：</p>
          ...
          <div>
            <h4 style="font-weight:600;">3.3 测试人工成本计算如式(3)所示：</h4>
          ...
          <div>
            <h4 style="font-weight:600;">3.4 测试工具成本计算如式(4)所示：</h4>
          ...
          <div>
            <h4 style="font-weight:600;">3.5 软件测试直接成本计算如式(5)所示：</h4>
          ...
          <div>
            <h4 style="font-weight:600;">3.6 软件测试成本计算如式(6)所示：</h4>
